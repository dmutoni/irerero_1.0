...
class NumberDetailScreen2 extends ConsumerStatefulWidget {
  static const String routeName = '/number-detail-screen-2';
  const NumberDetailScreen2({Key? key}) : super(key: key);

  @override
  ConsumerState<NumberDetailScreen2> createState() =>
      _NumberDetailScreenState();
}

class _NumberDetailScreenState extends ConsumerState<NumberDetailScreen2> {
    ...
    return Scaffold(
      body: buildNumberDetailsTemplate(
        ...
        onPlayNext: () => NavigatorHelper.pushNamed(
          NumberDetailsScreenWithPuppyBackground2.routeName,
        ),
        ...
        content: Stack(
          ...
          children: [
            ...
            Image.asset(
              'assets/images/number_details/number_two.png',
              fit: BoxFit.contain,
            ),
            Positioned(
              bottom: 10,
